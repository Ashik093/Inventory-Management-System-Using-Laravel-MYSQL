...
<head>
    ...
    <script src="https://use.fontawesome.com/1e394e9d61.js"></script>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.employee') }}"></a></li>
                                    <li><a href="{{ route('all.employee') }}"></a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-users"></i><span> Salary (Employee) </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-users"></i><span> Product </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.product') }}">Add Product</a></li>
                                    <li><a href="{{ route('all.product') }}">All Product</a></li>
                                    <li><a href="{{ route('import.product') }}">Export And Import</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-event"></i><span> Expenses </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-users"></i><span> Attendence </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-users"></i><span> Setting </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
